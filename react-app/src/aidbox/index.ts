...
export interface Account {
    ...
    subject?: Array<AidboxReference<Patient | Device | Practitioner | PractitionerRole | Location | HealthcareService | Organization>>;
...
export interface AdverseEvent {
    ...
    subjectMedicalHistory?: Array<AidboxReference<Condition | Observation | AllergyIntolerance | FamilyMemberHistory | Immunization | Procedure | Media | DocumentReference>>;
...
export interface AdverseEventSuspectEntity {
    ...
    instance: AidboxReference<Immunization | Procedure | Substance | Medication | MedicationAdministration | MedicationStatement | Device>;
    /** Extensions that cannot be ignored even if unrecognized */
    modifierExtension?: Extension[];
}
...
export interface AppointmentParticipant {
    ...
    actor?: AidboxReference<Patient | Practitioner | PractitionerRole | RelatedPerson | Device | HealthcareService | Location>;
    /** Additional content defined by implementations */
    extension?: Extension[];
    /** Unique id for inter-element referencing */
    id?: string;
...
export interface AppOperations {
    action?: string;
    method?: 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH' | 'OPTION' | 'get' | 'post' | 'put' | 'delete' | 'patch' | 'option';
    path?: any[];
...
export interface CarePlan {
    ...
    author?: AidboxReference<Patient | Practitioner | PractitionerRole | Device | RelatedPerson | Organization | CareTeam>;
    /** Fulfills CarePlan */
    ...
    contributor?: Array<AidboxReference<Patient | Practitioner | PractitionerRole | Device | RelatedPerson | Organization | CareTeam>>;
...
export interface CarePlanActivity {
    ...
    reference?: AidboxReference<Appointment | CommunicationRequest | DeviceRequest | MedicationRequest | NutritionOrder | Task | ServiceRequest | VisionPrescription | RequestGroup>;
}
...
export interface CarePlanActivityDetail {
    ...
    performer?: Array<AidboxReference<Practitioner | PractitionerRole | Organization | RelatedPerson | Patient | CareTeam | HealthcareService | Device>>;
...
export interface CatalogEntry {
    ...
    referencedItem: AidboxReference<Medication | Device | Organization | Practitioner | PractitionerRole | HealthcareService | ActivityDefinition | PlanDefinition | SpecimenDefinition | ObservationDefinition | Binary>;
...
export interface ChargeItem {
    ...
    service?: Array<AidboxReference<DiagnosticReport | ImagingStudy | Immunization | MedicationAdministration | MedicationDispense | Observation | Procedure | SupplyDelivery>>;
...
export interface ChargeItemPerformer {
    ...
    actor: AidboxReference<Practitioner | PractitionerRole | Organization | CareTeam | Patient | Device | RelatedPerson>;
    /** Additional content defined by implementations */
    extension?: Extension[];
...
export interface Client {
    ...
    description?: string;
    first_party?: boolean;
    grant_types?: 'basic' | 'authorization_code' | 'code' | 'password' | 'client_credentials' | 'implicit' | 'refresh_token'[];
    scopes?: ClientScopes[];
    secret?: string;
    smart?: ClientSmart;
}
...
export interface ClinicalImpressionInvestigation {
    ...
    item?: Array<AidboxReference<Observation | QuestionnaireResponse | FamilyMemberHistory | DiagnosticReport | RiskAssessment | ImagingStudy | Media>>;
    /** Extensions that cannot be ignored even if unrecognized */
    modifierExtension?: Extension[];
}
...
export interface Communication {
    ...
    received?: dateTime;
    /** Message recipient */
    recipient?: Array<AidboxReference<Device | Organization | Patient | Practitioner | PractitionerRole | RelatedPerson | Group | CareTeam | HealthcareService>>;
    /** Message sender */
    sender?: AidboxReference<Device | Organization | Patient | Practitioner | PractitionerRole | RelatedPerson | HealthcareService>;
    /** When sent */
    sent?: dateTime;
...
export interface ConsentProvisionActor {
    ...
    reference: AidboxReference<Device | Group | CareTeam | Organization | Patient | Practitioner | RelatedPerson | PractitionerRole>;
...
export interface ContractTermAction {
    ...
    performer?: AidboxReference<RelatedPerson | Patient | Practitioner | PractitionerRole | CareTeam | Device | Substance | Organization | Location>;
    /** Pointer to specific item */
    ...
    reasonLinkId?: string[];
    /** Why is action (not) needed? */
    reasonReference?: Array<AidboxReference<Condition | Observation | DiagnosticReport | DocumentReference | Questionnaire | QuestionnaireResponse>>;
    /** Who asked for action */
    requester?: Array<AidboxReference<Patient | RelatedPerson | Practitioner | PractitionerRole | Device | Group | Organization>>;
    /** Pointer to specific item */
...
export interface ContractTermActionSubject {
    ...
    modifierExtension?: Extension[];
    /** Entity of the action */
    reference: Array<AidboxReference<Patient | RelatedPerson | Practitioner | PractitionerRole | Device | Group | Organization>>;
...
export interface DeviceRequest {
    ...
    /** Requested Filler */
    performer?: AidboxReference<Practitioner | PractitionerRole | Organization | CareTeam | HealthcareService | Patient | Device | RelatedPerson>;
    /** Filler role */
    performerType?: CodeableConcept;
...
export interface DeviceUseStatement {
    ...
    contained?: Resource[];
    /** Supporting information */
    derivedFrom?: Array<AidboxReference<ServiceRequest | Procedure | Claim | Observation | QuestionnaireResponse | DocumentReference>>;
...
export interface DiagnosticReport {
    ...
    meta?: Meta;
    /** What was requested */
    basedOn?: Array<AidboxReference<CarePlan | ImmunizationRecommendation | MedicationRequest | NutritionOrder | ServiceRequest>>;
    /** Service category */
    category?: CodeableConcept[];
...
export interface FamilyMemberHistory {
    ...
    reasonCode?: CodeableConcept[];
    /** Why was family member history performed? */
    reasonReference?: Array<AidboxReference<Condition | Observation | AllergyIntolerance | QuestionnaireResponse | DiagnosticReport | DocumentReference>>;
...
export interface Flag {
    ...
    subject: AidboxReference<Patient | Location | Group | Organization | Practitioner | PlanDefinition | Medication | Procedure>;
    /** Text summary of the resource, for human interpretation */
    text?: Narrative;
}
...
export interface Goal {
    ...
    addresses?: Array<AidboxReference<Condition | Observation | MedicationStatement | NutritionOrder | ServiceRequest | RiskAssessment>>;
...
export interface Media {
    ...
    operator?: AidboxReference<Practitioner | PractitionerRole | Organization | CareTeam | Patient | Device | RelatedPerson>;
...
export interface MedicationRequest {
    ...
    performer?: AidboxReference<Practitioner | PractitionerRole | Organization | Patient | Device | RelatedPerson | CareTeam>;
...
export interface MedicationStatement {
    ...
    note?: Annotation[];
    /** Part of referenced event */
    partOf?: Array<AidboxReference<MedicationAdministration | MedicationDispense | MedicationStatement | Procedure | Observation>>;
...
export interface Observation {
    ...
    meta?: Meta;
    /** Fulfills plan, proposal or order */
    basedOn?: Array<AidboxReference<CarePlan | DeviceRequest | ImmunizationRecommendation | MedicationRequest | NutritionOrder | ServiceRequest>>;
    /** Observed body part */
    bodySite?: CodeableConcept;
    ...
    derivedFrom?: Array<AidboxReference<DocumentReference | ImagingStudy | Media | QuestionnaireResponse | Observation | MolecularSequence>>;
    /** (Measurement) Device */
    ...
    note?: Annotation[];
    /** Part of referenced event */
    partOf?: Array<AidboxReference<MedicationAdministration | MedicationDispense | MedicationStatement | Procedure | Immunization | ImagingStudy>>;
    /** Who is responsible for the observation */
    performer?: Array<AidboxReference<Practitioner | PractitionerRole | Organization | CareTeam | Patient | RelatedPerson>>;
...
export interface Procedure {
    ...
    reasonReference?: Array<AidboxReference<Condition | Observation | Procedure | DiagnosticReport | DocumentReference>>;
...
export interface Schedule {
    ...
    actor: Array<AidboxReference<Patient | Practitioner | PractitionerRole | RelatedPerson | Device | HealthcareService | Location>>;
...
export interface ServiceRequest {
    ...
    patientInstruction?: string;
    /** Requested performer */
    performer?: Array<AidboxReference<Practitioner | PractitionerRole | Organization | CareTeam | HealthcareService | Patient | Device | RelatedPerson>>;
    /** Performer role */
    performerType?: CodeableConcept;
    /** routine | urgent | asap | stat */
    priority?: code;
...
export interface Task {
    ...
    owner?: AidboxReference<Practitioner | PractitionerRole | Organization | CareTeam | HealthcareService | Patient | Device | RelatedPerson>;
    /** Composite task */
...
export interface TaskRestriction {
    ...
    recipient?: Array<AidboxReference<Patient | Practitioner | PractitionerRole | RelatedPerson | Group | Organization>>;
